  ...
  return (
    <div className="progress-container">
      ...
      <div className="button-container">
        ...
        <button onClick={() => fillProgressBar(25)}>1</button>
        <button onClick={() => fillProgressBar(50)}>2</button>
        <button onClick={() => fillProgressBar(75)}>3</button>
        <button onClick={() => fillProgressBar(100)}>4</button>
